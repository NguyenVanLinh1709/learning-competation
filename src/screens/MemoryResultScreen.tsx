...
type Props = { navigation: NativeStackNavigationProp<RootStackParamList, 'MemoryResult'> };
...
export default function MemoryResultScreen({ navigation }: Props) {
  const { config, score, correctCount, wrongCount, responseTimes, resetGame, initGame } = useMemoryStore();
