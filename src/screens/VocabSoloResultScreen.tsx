...
type Props = { navigation: NativeStackNavigationProp<RootStackParamList, 'VocabSoloResult'> };
    ...
    <LinearGradient colors={G.home} style={styles.outer}>
      <View style={[styles.scroll, { paddingTop: insets.top + 20, paddingBottom: insets.bottom + 40 }]}>
        ...
        <Animated.View style={[styles.banner, { transform: [{ scale: bannerScale }] }]}>
          ...
          <Text style={[styles.completeText, { color: C.text }]}>{t.vocabSoloComplete}</Text>
...
const styles = StyleSheet.create({
  ...
  playAgainBtn: { borderRadius: 18, overflow: 'hidden', shadowColor: ACCENT, shadowOffset: { width: 0, height: 5 }, shadowOpacity: 0.4, shadowRadius: 12, elevation: 6 },
